...
df =  psql.read_sql("SELECT latitud, longitud FROM trayectoria_gye ",conn2)
coords = df.as_matrix(columns=['latitud', 'longitud'])
#coords
#coords = dataframe2.as_matrix()
#for puntos in coords1
#def2= psql.read_sql("Insert into trayetoria(latitud, longitud) values (puntos) ",conn3)
...
rep_points.to_csv('C:/Users/saludsa/Videos/prueba/public/img/images/python/centroides-dbscanCal_DBSCAM.csv', encoding='utf-8')
algo.to_csv('C:/Users/saludsa/Videos/prueba/public/img/images/python/clustes-dbscancal_DBSCAM.csv', encoding='utf-8')
df.to_csv('C:/Users/saludsa/Videos/prueba/public/img/images/python/DataSetCal_DBSCAM.csv', encoding='utf-8')
...
plt.xlabel('Latitud')
plt.ylabel('Longitud')
plt.savefig('C:/Users/saludsa/Videos/prueba/public/img/images/dbScanCal.png', dpi=300, bbox_inches='tight', pad_inches=0.1)
#plt.show()
